...
public class ServicesTab {
    ...
    public Tab createServicesTab() {
        servicesTab = new Tab("Services");

        initServicesTabContentView();

        return servicesTab;
    }

    private void initServicesTabContentView() {
        initCategoriesTable();
...
//                }
    ...
    private void initLayout() {
        ...
        mainPane.add(servicesContent, 0, 1);
        ...
        servicesTab.setContent(mainPane);
    }
